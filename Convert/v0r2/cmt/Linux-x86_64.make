...
use_linkopts= $(cmt_installarea_linkopts)   $(Convert_linkopts)  $(RootW_linkopts) 
...
use_requirements=requirements $(CMTROOT)/mgr/requirements $(ROOTWROOT)/cmt/requirements 
use_includes= $(ppcmd)"$(RootW_root)/src" 
use_fincludes= $(use_includes)
use_stamps= $(Convert_stamps)  $(RootW_stamps) 
use_cflags=  $(Convert_cflags)  $(RootW_cflags) 
use_pp_cflags=  $(Convert_pp_cflags)  $(RootW_pp_cflags) 
use_cppflags=  $(Convert_cppflags)  $(RootW_cppflags) 
use_pp_cppflags=  $(Convert_pp_cppflags)  $(RootW_pp_cppflags) 
use_fflags=  $(Convert_fflags)  $(RootW_fflags) 
use_pp_fflags=  $(Convert_pp_fflags)  $(RootW_pp_fflags) 
use_libraries= $(RootW_libraries) 
includes= $(ppcmd)"$(srcdir)" $(use_includes)
fincludes= $(includes)
ShowerIO_use_linkopts=  $(Convert_linkopts)  $(RootW_linkopts) 
ShowerROOT_use_linkopts=  $(Convert_linkopts)  $(RootW_linkopts) 
Utils_use_linkopts=  $(Convert_linkopts)  $(RootW_linkopts) 
CorsToRoot_use_linkopts=  $(Convert_linkopts)  $(RootW_linkopts) 
constituents= ShowerROOTDict ShowerIO ShowerROOT Utils CorsToRoot 
all_constituents= $(constituents)
constituentsclean= CorsToRootclean Utilsclean ShowerROOTclean ShowerIOclean ShowerROOTDictclean 
