//----------------------------------------------------------------------
/*
  LHAASIM Program - IPN Orsay since December 2002
...
class PMT_MD
{
 ...
 public:
  ...
  map<Int_t,Double_t> fPMTSignal_hi_mu;
...
class HitStationMD : public TObject,public SampStation
{
 private:
 ...
 public:
  ...
  HitStationMD();
  HitStationMD(Int_t id, Float_t north,Float_t east,Float_t alt);   
  HitStationMD(Int_t id, Float_t north,Float_t east); //used to have an array of event cores
  ~HitStationMD();
  ...
  int DoTrigSim();
  int TestToT();
  int TestThreshold(int th);
  double GetChargeInVEM();
  ClassDef(HitStationMD,1)
...
class HitStationED : public TObject,public SampStation
{
 private:
 ...
 vector<Int_t> fMuTimes;
  ...
  HitStationED();
  HitStationED(Int_t id, Float_t north,Float_t east,Float_t alt);   
  HitStationED(Int_t id, Float_t north,Float_t east); //used to have an array of event cores
  ~HitStationED();
  ...
  void SetTime0();
  void SetTime0(double time0);
  void ReadParticleInScint(ParticleInScint* p);
  int TestToT();
  int TestThreshold(int th);
  int DoTrigSim();
  ClassDef(HitStationED,1)

};



class HitStationLightED : public TObject
{
 private:
 ...
 public:
  ...
  HitStationLightED();
  HitStationLightED(const HitStationED&);
  ~HitStationLightED();

  ClassDef(HitStationLightED,1)
